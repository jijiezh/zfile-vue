<template>
	<Contextmenu auto-ajust-placement ref="contextmenu">
		<template v-if="contextMenuTargetFile">
			...
			<ContextmenuItem
				v-show="
					storageConfigStore.permission.download &&
					selectStatistics.isSingleSelect
				"
			...
			<ContextmenuItem
				v-show="
					storageConfigStore.permission.download &&
					selectStatistics.isMultiSelect &&
					storageConfigStore.permission.batchDownload
				"
				@click="batchDownloadFile"
			>
				<el-icon class="contextmenu-icon">
			...
			<ContextmenuItem
				v-show="
					storageConfigStore.permission.download &&
					selectStatistics.isMultiSelect &&
					storageConfigStore.permission.packageDownload
				"
		...
		<ContextmenuItem
			v-show="storageConfigStore.permission.showDateset"
			@click="openFileTreeDialogVisible"
		>
			<el-icon class="contextmenu-icon">
				<i-custom-preview />
			</el-icon>
...
const { openFileTreeDialogVisible } = useFileTreeChoose()
