		...
		<div class="zfile-img-body" v-if="transferResult.length > 0">
			...
			>
				<div
					...
					@contextmenu="openContextMenu($event, colItem)"
					:style="{
						display:
				...
				>
					<template v-if="colItem?.url">
						<img
							class="zfile-gallery-img lazyload"
							data-sizes="auto"
							@load="loadImg"
							:class="
								globalConfigStore.zfileConfig.gallery.roundedBorder
						...
						<div
							v-if="
								globalConfigStore.zfileConfig.gallery.showInfo &&
								globalConfigStore.zfileConfig.gallery.showInfoMode === 'hover'
							"
							:class="
								globalConfigStore.zfileConfig.gallery.roundedBorder
						...
						>
							...
							<span class="zfile-gallery-img-text">{{
...
let galleryRowWidth = computed(() => {
	...
	return `calc(calc(100% / ${
		globalConfigStore.zfileConfig.gallery.column
	}) - calc(${
