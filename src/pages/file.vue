...
// 选择文件树
const chooseFileTree = defineAsyncComponent({
	loader: () => import('~/components/file/preview/chooseFileTree.vue'),
...
let { checkSelectable, selectRowsChange, tableRowClassName } =
...
const { fileTreeDialogVisible } = useFileTreeChoose()
